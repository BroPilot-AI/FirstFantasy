...
export class ClinicScene {
    ...
    init(el) {
        this.el = el;
        this.el.innerHTML = `
            <div id="clinic-scene" style="width:100%;height:100%;display:flex;flex-direction:row;background:#0d0221;color:white;padding:20px;box-sizing:border-box;">
                <div style="flex:1; display:flex; flex-direction:column; justify-content:center; align-items:center; border-right:2px solid #0f0; padding-right:20px;">
                    ...
                    <p id="clinic-dialogue" style="text-align:center; font-style:italic;">"Need a tune up? I can patch your crew up for 50 credits."</p>
                </div>
                <div style="flex:1; padding-left:20px; display:flex; flex-direction:column; justify-content:center;">
                    <div style="font-size:24px; color:var(--neon-blue); margin-bottom:20px;">Credits: <span id="clinic-credits">0</span></div>
                    <div style="display:flex; flex-direction:column; gap:10px;">
                        <button class="cyber-btn" id="btn-heal" style="font-size:18px;">Full Heal Party (50C)</button>
                        <button class="cyber-btn" id="btn-leave-clinic" style="font-size:18px; margin-top:20px;">Leave Clinic</button>
                    </div>
                </div>
            </div>
        `;
